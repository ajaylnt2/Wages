class GlobalSummaryController {
    constructor($rootScope, $scope, auth, $timeout, $http) {
        ...
        $(function () {
            ...
            $http.get("app/frameworkPages/dashboardMain/globalMain/globalSummary/globalData.json")
                .then(function (data) {
                    ...
                    $('#container').highcharts('Map', {
                        ...
                        series: [{
                            ...
                            point: {
                                events: {
                                    click: function () {
                                        this.selecteddata = this.code;
                                        var totaldata = this.googleMapTableData;
                                        angular.forEach(totaldata, function (value, key) {
                                            if (this.selecteddata.toString() == value.code.toString()) {
