...
disabledDaySelect()
{
  ...
  init(data, color, status) {
    ...
    var obj = this;
    this.performanceService.getBoilerPerformance()
      .then(function(data) {
...
export default BoilerPerformanceController;
